...
export const Header = ({ currentStation, maskedStationName }: Props) => {
	return (
		<header className="w-full flex justify-between items-center shadow-md bg-[#f8f8f8] px-1">
			<nav>
				<button className="noborder text-sky-600 p-2!" onClick={() => window.location.reload()}>
			...
			<nav>
				<button className="noborder text-emerald-500 p-2!" onClick={() => window.location.reload()}>
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
